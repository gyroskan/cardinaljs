...
export class APIError extends Error {
  constructor(
      message: string, code: number, method: string, path: string,
      body: string|null);
  code: number;
  method: string;
  path: string;
...
export class Api {
  constructor(
      token: string, apiurl?: string|undefined, maxAttempt?: number|undefined);
  private token;
  apiurl: string;
  private header;
  private maxAttempt;
  connect(): Promise<string>;
  request(path: string, method: string, object?: object|undefined):
      Promise<object>;
}
...
export class GuildManager {
  ...
  create(guild: {
    guildID: Snowflake; guildName: string;
...
export class Member {
  ...
  ban(options: {
    ...
    bannerID?: Snowflake | undefined;
    auto?: boolean | undefined;
  }): Promise<Member>;
  warn(options:
           {reason?: string|undefined; warnnerID?: Snowflake | undefined;}):
      Promise<Member>;
  delete(): Promise<boolean>;
...
export class Channel {
  ...
  get id(): Snowflake;
  edit(data:
           {ignored?: boolean|undefined; xpBlacklisted?: boolean | undefined;}):
      Promise<Channel>;
  delete(): Promise<boolean>;
}